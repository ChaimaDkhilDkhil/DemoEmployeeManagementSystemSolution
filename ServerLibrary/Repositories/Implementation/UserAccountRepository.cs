...
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccountService
    {
        ...
        public async Task<LoginResponse> SignInAsync(Login user)
        {
            ...
            // enregistrer le refresh Token à la base de donnés
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            var user = await appDbContext.ApplicationUsers
                .FirstOrDefaultAsync(x => x.Id == findToken.UserId);
